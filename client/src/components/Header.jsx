...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >Unleash
                your creativity with AI. Turn your imagination into visual art in seconds just type, and watch the magic happen.</motion.p>
            ...
            >
                {Array(6).fill('').map((item, index)=>(
                    <motion.img whileFocus={{scale:1.05, duration:1}} className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10'
        ...
        className='mt-2 text-neutral-600'>Generated images from AI-image-generator.</motion.p>               
        </motion.div>
    )
}
